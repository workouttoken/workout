...
contract WorkoutToken is ERC20, Owner {
    ...
    function startDistribution() isSuperOwner public {
        ...
        if(confirmationStatus==0) {
            ...
            _transfer(address(this), trainEarn1Address, 1500000000000000000000000000);
            _transfer(address(this), trainEarn2Address, 1500000000000000000000000000);
            _transfer(address(this), trainEarn3Address, 1500000000000000000000000000);
            _transfer(address(this), liq1Address, 1500000000000000000000000000);
            _transfer(address(this), liq2Address, 1500000000000000000000000000);
            _transfer(address(this), marketing1Address, 1125000000000000000000000000);
            _transfer(address(this), marketing2Address, 1125000000000000000000000000);
            _transfer(address(this), publicSaleAddress, 1500000000000000000000000000);
            _transfer(address(this), dev1Address, 750000000000000000000000000);
            _transfer(address(this), dev2Address, 750000000000000000000000000);
            _transfer(address(this), team1Address, 750000000000000000000000000);
            _transfer(address(this), team2Address, 750000000000000000000000000);
            _transfer(address(this), advAddress, 450000000000000000000000000);
            _transfer(address(this), privAddress, 300000000000000000000000000);
